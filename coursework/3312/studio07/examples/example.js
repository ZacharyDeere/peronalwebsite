...
document.addEventListener('DOMContentLoaded', function () {
   ...
   document.querySelector('#run-experiments').addEventListener('click', function () {
      ...
      // You can delete an element, but the other elements are not shifted down.
      delete array[1];
      outputString += getArrayInfoString(array);

      // The splice method can delete elements and shift others down.
      array.splice(1, 2); // Deletes 2 elements starting at index 1.
      outputString += getArrayInfoString(array);
      ...
      // The join method can create a string out of elements.
   ...
   document.querySelector('#calculate-factorial').addEventListener('click', function () {
      ...
      factorial = (function () {
         ...
         factorialResults = [1]; // factorialResults = []; factorialResults[0] = 1;

         // A function has access to variables in the function in which it is created.
         return function f(n) {
            // Make sure that n is an integer.
            n = Math.round(n);
            // n needs to be a nonnegative number to calculate a factorial.
      ...
      if (typeof outputNumber === 'number' && isFinite(outputNumber)) {
   ...
   (function () {
      ...
      digitElements = Array.prototype.slice.call(document.querySelectorAll('#numerical-input div'));
      numberBuilt = 0;
   ...
   (function () {
      ...
      Array.prototype.slice.call(document.querySelectorAll('#lights tr')).forEach(function (row) {
